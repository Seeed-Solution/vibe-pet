...
| --- | --- | --- | --- | --- |
| [SenseCAP Indicator](https://wiki.seeedstudio.com/ja/Sensor/SenseCAP/SenseCAP_Indicator/Get_started_with_SenseCAP_Indicator/) | 4インチ 480×480 タッチディスプレイ | BLE | ✅️ | ESP32-S3 + RP2040；ST7701S RGB ディスプレイ；LVGL キャラクター描画。 |
| [Wio Terminal](https://www.seeedstudio.com/Wio-Terminal-p-4509.html) | メインのアニメーション表示デバイス | BLE | Ing | 安定した BLE アニメーション表示ターゲットです。 |
| [Vibe Pet](https://espai.fun/open/pcb/mini-ext/1.0.0/) | ESP32-S3 ベースの AI 開発キット | BLE | ✅️ | TFT ターゲット。LVGL キャラクター描画。 |
...
[Releases page](https://github.com/Seeed-Solution/vibe-pet/releases) から、お使いのプラットフォーム向けのインストーラーをダウンロードしてください。
...
### macOS で「Vibe Pet は破損しているため開けません」と表示される

これは Gatekeeper のブロック（未署名または未 notarize）で、アプリの実行時クラッシュではありません。まず隔離属性を削除してください。
