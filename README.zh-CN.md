...
| --- | --- | --- | --- | --- |
| [SenseCAP Indicator](https://wiki.seeedstudio.com/cn/Sensor/SenseCAP/SenseCAP_Indicator/Get_started_with_SenseCAP_Indicator/) | 4 英寸 480×480 触控屏 | BLE | ✅️ | ESP32-S3 + RP2040；ST7701S RGB 显示屏；LVGL 角色渲染。 |
| [Wio Terminal](https://www.seeedstudio.com/Wio-Terminal-p-4509.html) | 主显示端，用于显示桌宠动画 | BLE | Ing | 成熟的 BLE 动画显示目标。 |
| [Vibe Pet](https://espai.fun/open/pcb/mini-ext/1.0.0/) | 基于 ESP32-S3 的 AI 开发套件 | BLE | ✅️ | TFT 目标；LVGL 角色渲染。 |
